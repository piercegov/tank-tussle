...
extern const double THIS_IS_A_HALF;
...
/**
Checks if v3 is within the square region defined by v1 and v2.
*/
...
/**
* Computes the average of two vectors, i.e. the average x and y components.
*
* @param v1 the first vector
* @param v2 the second vector
* @return the average of v1, v2
*/
